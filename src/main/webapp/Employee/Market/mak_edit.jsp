...
<%
	String yuqshour = request.getParameter("yuqshour");
	session.setAttribute("yuqshour",yuqshour);
%>
<%
	String yucshour = request.getParameter("yucshour");
	session.setAttribute("yucshour",yucshour);
%>
<%
...
%>
  ...
  <body>
    ...
    <div class="x-body">
        <form action="${pageContext.request.contextPath }/market/updateMarket.action"  enctype="multipart/form-data" method="post">
         <div class="layui-form-item">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="flag" name="flag" value="${flag}"   class="layui-input">
              </div>
            ...
            <div class="layui-form-item">
              ...
              <label for="L_email" class="layui-form-label">
                  <span class="x-red">*</span>预期收入
              </label>
              <div class="layui-input-inline">
                  <input type="text" id="yuqshour" name="yuqshour"  value="${yuqshour}" class="layui-input">
              </div>
          ...
          <div class="layui-form-item">
              ...
              <label for="L_email" class="layui-form-label">
                  <span class="x-red">*</span>预测收入
              </label>
              <div class="layui-input-inline">
                  <input type="text" id="yucshour" name="yucshour"  value="${yucshour}"  class="layui-input">
              </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="shjshour" name="shjshour"   value="${shjshour}" readonly  unselectable="on" class="layui-input">
              </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  <input type="file" id="path1" name="path1"     class="layui-input">
