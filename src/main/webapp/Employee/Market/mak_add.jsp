...
%>
  ...
  <body>
    ...
    <div class="x-body">
        <form action="${pageContext.request.contextPath }/market/addMarket.action" enctype="multipart/form-data" method="post">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="flag" name="flag"   class="layui-input">
              </div>
            ...
            <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="yuqshour" name="yuqshour"   class="layui-input">
              </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="yucshour" name="yucshour"   class="layui-input">
              </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="shjshour" name="shjshour"     class="layui-input">
              </div>
