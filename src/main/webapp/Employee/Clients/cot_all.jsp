    ...
    <div class="x-body">
     <%-- <form action="./Backstage/"></form> --%>
      <table class="layui-table x-admin">
        ...
        <tbody>
        <c:forEach items="${pageInfo.list }" var="erecord">
            ...
            <td>${erecord.name}</td>
            <td><fmt:formatDate value="${erecord.date}" pattern="yyyy-MM-dd"/> </td>
            <td>${erecord.neirong}</td>
			...
			<tr style="FONT-WEIGHT: bold; FONT-SIZE: 12pt; HEIGHT: 25px; BACKGROUND-COLOR: #afd1f3">
				...
				<a
					href="${ pageContext.request.contextPath }/clients/findERecordByPage.action?page=1&eId=${id}">首页</a>
					|<a
					href="${ pageContext.request.contextPath }/clients/findERecordByPage.action?page=${pageInfo.pageNum==1?1:pageInfo.pageNum-1}&eId=${id}">上一页</a>
					| <a
					href="${ pageContext.request.contextPath }/clients/findERecordByPage.action?page=${pageInfo.pageNum==pageInfo.pages?pageInfo.pages:pageInfo.pageNum+1}&eId=${id}">下一页</a>
					|<a
					href="${ pageContext.request.contextPath }/clients/findERecordByPage.action?page=${pageInfo.pages}&eId=${id}">尾页</a></td>
