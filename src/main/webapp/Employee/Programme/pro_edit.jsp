...
%>
  ...
  <body>
    ...
    <div class="x-body">
        <form action="${pageContext.request.contextPath }/programme/updateProgramme.action"  enctype="multipart/form-data" method="post">
         <div class="layui-form-item">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="location" name="location" value="${location}"   class="layui-input">
              </div>
            ...
            <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="tlocation" name="tlocation"  value="${tlocation}" class="layui-input">
              </div>
          </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="etel" name="etel"   value="${etel}" readonly  unselectable="on" class="layui-input">
              </div>
