...
<%
	...
	session.setAttribute("usercord",usercord);
%>
  ...
  <body>
    ...
    <div class="x-body">
        <form action="${pageContext.request.contextPath }/user/updateuser1.action" enctype="multipart/form-data" method="post">
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <div id="preview" >
                  	<img alt="" src="http://localhost:8080/img/${user.img}">
                  </div>
                  <input type="file" name="img1" id="file" onchange="preview(this)" ><br/>
				  <input type="hidden" name="img" id="img" value="${user.img}" class="form-control">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text"  name="weixin" value="${user.weixin}" class="layui-input">
              </div>
          </div>
          <div class="layui-form-item">
              <label for="L_username" class="layui-form-label">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="date" id="date1" name="date1" value="${user.date}" class="layui-input" >
              		<input type="text" name="date" id="date"  value="<fmt:formatDate value="${user.date}" pattern="yyyy-MM-dd"/>" class="form-control">
              </div>
          </div>
          <input type="hidden" id="id" name="id" value="${user.id}">
          <input type="hidden" id="usercord" name="usercord" value="${user.usercord}">
