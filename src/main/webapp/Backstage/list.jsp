     ...
     <%-- <form action="./Backstage/"></form> --%>
      <table class="layui-table x-admin">
        ...
        <c:forEach items="${pageInfo.list }" var="user">
            ...
            <td class="td-manage">
             <a title="编辑"  onclick="x_admin_show('修改用户信息','http://localhost:8080/CRM/Backstage/user_edit.jsp?id=${user.id}&gender=${user.gender}&usercord=${user.usercord}&qq=${user.qq}&weixin=${user.weixin}&date=<fmt:formatDate value="${user.date}" pattern="yyyy-MM-dd"/>&location=${user.location}&phone=${user.phone}&email=${user.email}&name=${user.name}',600,400)" href="javascript:;">
			...
			<tr style="FONT-WEIGHT: bold; FONT-SIZE: 12pt; HEIGHT: 25px; BACKGROUND-COLOR: #afd1f3">
				...
				<a
					href="${ pageContext.request.contextPath }/user/findUserByPage.action?page=1">首页</a>
					|<a
					href="${ pageContext.request.contextPath }/user/findUserByPage.action?page=${pageInfo.pageNum==1?1:pageInfo.pageNum-1}">上一页</a>
					| <a
					href="${ pageContext.request.contextPath }/user/findUserByPage.action?page=${pageInfo.pageNum==pageInfo.pages?pageInfo.pages:pageInfo.pageNum+1}">下一页</a>
					|<a
					href="${ pageContext.request.contextPath }/user/findUserByPage.action?page=${pageInfo.pages}">尾页</a></td>
