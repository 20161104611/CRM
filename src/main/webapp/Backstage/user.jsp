    ...
    <div class="container">
        ...
        <ul class="layui-nav right" lay-filter="">
          <li class="layui-nav-item">
            ...
            <dl class="layui-nav-child"> <!-- 二级菜单 -->
              <dd><a href="http://localhost:8080/CRM/Backstage/admin_password.jsp?id=${user.id}&name=${user.name}&usercord=${user.usercord}" >修改密码</a></dd>
        ...
        <ul id="nav">
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a _href="${pageContext.request.contextPath }/user/findUserByPage.action">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>会员列表</cite>
